...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        Contact.objects.create(phonenumber='1234567890',email='a8208226@gmail.com',linkprecedence='primary')
        Contact.objects.create(phonenumber='12345342890',email='a8242308226@gmail.com',linkprecedence='primary')
